...
def starogajowa(df: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    df, r2 = select_asset(df, (
            ...
            | (df[AssetRw.MBANK_ACCOUNT_NUMBER] == "04102010269000000022415575")  # PGNIG STAROGAJOWA
            | (df[AssetRw.MBANK_ACCOUNT_NUMBER] == "14109000048377000072886502")  # orange
            | (df[AssetRw.MBANK_ACCOUNT_NUMBER] == "78102052269493000000357543")  # śmieci indywidualny
