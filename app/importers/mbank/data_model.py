...
class MbankOperationTypeClass:
    ...
    PRZELEW_SEPA_PRZYCHODZACY = 'PRZELEW SEPA PRZYCHODZĄCY'
    PRZELEW_SEPA_WYCHODZACY = 'PRZELEW SEPA WYCHODZĄCY'
    PRZELEW_WALUTOWY_PRZYCHODZACY = 'PRZELEW WALUTOWY PRZYCHODZĄCY'
