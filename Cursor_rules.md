...
- Zakładka **Wartość aktywów**: u góry kontrolki snapshota obok RAP 1 (bez tytułu); poniżej RAP 2 na pełnej szerokości od lewej. Skład aktywów według portfeli — wyłącznie zakładka **Portfele**.
...
- FX w XIRR **pilli ROI / cash katalog** (legacy zostaje w walucie natywnej). XIRR **nazwanego portfela** (`portfolio_cf`) przelicza CF na PLN kursem NBP z dnia transakcji — świadomy wyjątek dual-run.
